...
class _BotCommands:
    def __init__(self):
        ...
        self.AuthorizeCommand = [f'authorize{CMD_SUFFIX}', f'auth{CMD_SUFFIX}']
        self.UnAuthorizeCommand = [
            f'unauthorize{CMD_SUFFIX}', f'unauth{CMD_SUFFIX}']
        ...
        self.SpeedtsCommand = [f'speedtest{CMD_SUFFIX}', 'speed']
        self.DirectCommand = [f'bypass{CMD_SUFFIX}', 'bp']
